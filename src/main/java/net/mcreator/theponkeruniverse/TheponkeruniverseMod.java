 ...
 *
 */
package net.mcreator.theponkeruniverse;
...
@Mod("theponkeruniverse")
public class TheponkeruniverseMod {
	public static final Logger LOGGER = LogManager.getLogger(TheponkeruniverseMod.class);
	public static final String MODID = "theponkeruniverse";
